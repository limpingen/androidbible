...
import org.sabda.alkitabquotegenerator.util.ThumbnailCleanupTask;
...
public class SettingsActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
   ...
   // @BindView(R.id.settings__toolbar)
    ...
    public void onCreate(Bundle b) {
        ...
        toolbar = findViewById(R.id.settings__toolbar);
        appBarLayout = findViewById(R.id.settings__appbar);
    ...
    public static class SettingsFragmentMaster extends PreferenceFragment {
        public static final String TAG = "org.sabda.alkitabquotegenerator.settings.SettingsFragmentMaster";
